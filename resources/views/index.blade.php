...
@include('layouts.nav')
    ...
    <section class="home-slider owl-carousel">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <h1 class="mb-4">Kopi Kami Kopi Indonesia</h1>
      ...
      <div class="slider-item" style="background-image: url(assets/frontend/coffee/images/kopi.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Welcome</span>
              <h1 class="mb-4">Kopi Kami Kopi Indonesia</h1>
              <p class="mb-4 mb-md-5">SElamat Datang Di Informasi Kopi</p>
              <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">See</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
